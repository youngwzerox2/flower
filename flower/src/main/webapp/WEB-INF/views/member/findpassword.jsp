						...
						<div class="customerservice-form">
							...
							<div class="row">
								<div class="col-lg-12">
									...
									<br/>
									<br/>
									<button id="findPassword" type="button" name="findPassword" class="btn btn-custom-size lg-size btn-pronia-primary">비밀번호 찾기</button>
									<button id="cancel" type="button" name="cancel" class="btn btn-custom-size lg-size btn-pronia-primary">취소</button>
									<br/>
									<br/>
								</div>
								<br/>
