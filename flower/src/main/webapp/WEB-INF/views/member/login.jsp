...
<title>꽃물주</title>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="../resources/member/assets/images/favicon.ico" />

    <!-- CSS
    ============================================ -->

    <link rel="stylesheet" href="../resources/member/assets/css/bootstrap.min.css" />
    <link rel="stylesheet" href="../resources/member/assets/css/font-awesome.min.css" />
    <link rel="stylesheet" href="../resources/member/assets/css/Pe-icon-7-stroke.css" />
    <link rel="stylesheet" href="../resources/member/assets/css/animate.min.css">
    <link rel="stylesheet" href="../resources/member/assets/css/swiper-bundle.min.css">
    <link rel="stylesheet" href="../resources/member/assets/css/nice-select.css">
    <link rel="stylesheet" href="../resources/member/assets/css/magnific-popup.min.css" />
    <link rel="stylesheet" href="../resources/member/assets/css/ion.rangeSlider.min.css" />
...
<body>
    ...
    <div class="main-wrapper">
                        ...
                        <div class="col-lg-12">
                            <div class="header-middle-wrap position-relative">
                                ...
                                <a href="index.html" class="header-logo">
                                    <img src="../resources/member/assets/images/logo/dark.png" alt="Header Logo">
                                </a>
                        ...
                        <ul class="minicart-list">
                            <li class="minicart-product">
                                ...
                                <a href="single-product-variable.html" class="product-item_img">
                                    <img class="img-full" src="../resources/member/assets/images/product/small-size/2-1-70x78.png" alt="Product Image">
                                </a>
                            ...
                            <li class="minicart-product">
                                ...
                                data-tippy-arrow="true" data-tippy-theme="sharpborder"></i></a>
                                <a href="single-product-variable.html" class="product-item_img">
                                    <img class="img-full" src="../resources/member/assets/images/product/small-size/2-2-70x78.png" alt="Product Image">
                                </a>
                                <div class="product-item_content">
                            ...
                            <li class="minicart-product">
                                ...
                                <a href="single-product-variable.html" class="product-item_img">
                                    <img class="img-full" src="../resources/member/assets/images/product/small-size/2-3-70x78.png" alt="Product Image">
                                </a>
                                <div class="product-item_content">
        ...
        <main class="main-content">
            <div class="breadcrumb-area breadcrumb-height" data-bg-image="../resources/member/assets/images/breadcrumb/bg/1-1-1919x388.jpg">
        ...
        <!-- Begin Footer Area -->
        <div class="footer-area" data-bg-image="../resources/member/assets/images/footer/bg/1-1920x465.jpg">
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="footer-widget-item">
                                <div class="footer-widget-logo">
                                    <a href="index.html">
                                        <img src="../resources/member/assets/images/logo/dark.png" alt="Logo">
                                    </a>
                                </div>
                        ...
                        <div class="col-lg-3 pt-40">
                            ...
                            <div class="payment-method">
                                <a href="#">
                                    <img src="../resources/member/assets/images/payment/1.png" alt="Payment Method">
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <script src="../resources/member/assets/js/vendor/bootstrap.bundle.min.js"></script>
    <script src="../resources/member/assets/js/vendor/jquery-3.6.0.min.js"></script>
    <script src="../resources/member/assets/js/vendor/jquery-migrate-3.3.2.min.js"></script>
    <script src="../resources/member/assets/js/vendor/jquery.waypoints.js"></script>
    <script src="../resources/member/assets/js/vendor/modernizr-3.11.2.min.js"></script>
    <script src="../resources/member/assets/js/plugins/wow.min.js"></script>
    <script src="../resources/member/assets/js/plugins/swiper-bundle.min.js"></script>
    <script src="../resources/member/assets/js/plugins/jquery.nice-select.js"></script>
    <script src="../resources/member/assets/js/plugins/parallax.min.js"></script>
    <script src="../resources/member/assets/js/plugins/jquery.magnific-popup.min.js"></script>
    <script src="../resources/member/assets/js/plugins/tippy.min.js"></script>
    <script src="../resources/member/assets/js/plugins/ion.rangeSlider.min.js"></script>
    <script src="../resources/member/assets/js/plugins/mailchimp-ajax.js"></script>
    <script src="../resources/member/assets/js/plugins/jquery.counterup.js"></script>
