								...
								<div class="header-right">
									<ul>
										...
										<li class="minicart-wrap me-3 me-lg-0"><a
											href="#miniCart" class="minicart-btn toolbar-btn"> <i
												class="pe-7s-shopbag"></i> <span class="quantity">3</span>
										</a></li>
										...
										<ul class="sub-menu">
											...
											<li class="menu-item-has-children"><a href="#"> <span
												...
												<ul class="sub-menu">
													...
													<li><a href="login"> <span class="mm-text">로그인</span>
													</a></li>
													<li><a href="register"> <span class="mm-text">회원가입</span>
													</a></li>
...
>>>>>>> refs/remotes/origin/20231107박민진
	...
	<script src="../resources/assets/js/member/register.js"></script>
