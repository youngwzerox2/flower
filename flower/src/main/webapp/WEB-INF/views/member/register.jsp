...
<body>
    ...
    <div class="main-wrapper">
                                    ...
                                    <ul>
                                        ...
                                        <li class="dropdown d-none d-lg-block">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="settingButton">
                                                ...
                                                <li><a class="dropdown-item" href="register">회원가입</a>
                                                </li>
                                            </ul>
                                        </li>
        ...
        <main class="main-content">
            <div class="breadcrumb-area breadcrumb-height" data-bg-image="../resources/assets/images/breadcrumb/bg/1-1-1919x388.jpg">
                            ...
                            <form action="register" method="post" id="regForm">
                                <div class="login-form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <label>회원명</label>
                                            <input id="member_name" name="member_name" type="text" placeholder="회원명" pattern="[A-Za-z가-힣]*" maxlength="19">
                                        </div>
                                        <div class="col-md-12">
                                            <label>이메일주소*</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 pt-40">
                            ...
                            <div class="payment-method">
                                <a href="#">
                                    <img src="../resources/assets/images/payment/1.png" alt="Payment Method">
                                </a>
                            </div>
                        </div>
                    </div>
