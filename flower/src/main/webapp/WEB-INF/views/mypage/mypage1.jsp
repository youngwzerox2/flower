                        ...
                        <div class="col-lg-12">
                            <div class="header-middle-wrap position-relative">
                                ...
                                <a href="index.html" class="header-logo">
                                    <img src="/flower/resources/assets/images/logo/dark.png" alt="Header Logo">
                                </a>
                        ...
                        <ul class="minicart-list">
                            <li class="minicart-product">
                                ...
                                <a href="single-product-variable.html" class="product-item_img">
                                    <img class="img-full" src="/flower/resources/assets/images/product/small-size/2-1-70x78.png" alt="Product Image">
                                </a>
                            ...
                            <li class="minicart-product">
                                ...
                                data-tippy-arrow="true" data-tippy-theme="sharpborder"></i></a>
                                <a href="single-product-variable.html" class="product-item_img">
                                    <img class="img-full" src="/flower/resources/assets/images/product/small-size/2-2-70x78.png" alt="Product Image">
                                </a>
                                <div class="product-item_content">
                            ...
                            <li class="minicart-product">
                                ...
                                <a href="single-product-variable.html" class="product-item_img">
                                    <img class="img-full" src="/flower/resources/assets/images/product/small-size/2-3-70x78.png" alt="Product Image">
                                </a>
                                <div class="product-item_content">
